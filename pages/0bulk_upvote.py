...
def main():
    ...
    post_url  = _input.input_template(label="The post url you wanna send upvotes to.")
        ...
        for i, line in enumerate(lines):
            try:
                ...
                if res["reddit_status_code"] != 200:
                    _error.failed_to(action="upvote", username=username, res=res)
                    continue

                success.success_to(action="upvoted", username=username)
