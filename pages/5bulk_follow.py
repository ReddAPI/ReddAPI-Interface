...
from interfaces.follow import follow
from src import validators
from src import utils


def main():
    clear_watermark.main(page_title="bulk follow")
        ...
        for i, line in enumerate(lines):
            try:
                ...
                if res["reddit_status_code"] != 200:
                    _error.failed_to(action="follow", username=username, res=res)
                    continue

                success.success_to(action="followed", username=username)
